...
path_sims =  os.path.abspath('../../../Desktop/impala_data/Ti64.TaylorCyl.NewAlpha/taylor_yu2011_T1/Results/')
add_tc_length(path_sims, 2.4493, xps)

path_sims =  os.path.abspath('../../../Desktop/impala_data/Ti64.TaylorCyl.NewAlpha/taylor_yu2011_T2/Results/')
add_tc_length(path_sims, 2.4095, xps)

path_sims =  os.path.abspath('../../../Desktop/impala_data/Ti64.TaylorCyl.NewAlpha/taylor_yu2011_T3/Results/')
