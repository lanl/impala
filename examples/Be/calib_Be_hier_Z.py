...
#path_to_results = '/vast/home/lvandervort/impala_runs/Be/hierarchical_zmachinermi/results/'
#path_to_plots = '/vast/home/lvandervort/impala_runs/Be/hierarchical_zmachinermi/plots/'

path_to_dir = '/Users/jyplohr/impala_runs/'
path_to_data = '/Users/jyplohr/impala_runs/Be/data/'
path_to_results = '/Users/jyplohr/impala_runs/Be/hierarchical_Z/results/'
path_to_plots = '/Users/jyplohr/impala_runs/Be/hierarchical_Z/plots/'
...
palette = ['tab:blue','tab:purple','tab:green']
...
## ERROR (10/06/2025)
## File "/Users/jyplohr/miniconda/envs/bubbles/lib/python3.12/site-packages/pandas/core/groupby/groupby.py", line 1946, in _agg_py_fallback
##    raise type(err)(msg) from err
## TypeError: agg function failed [how->mean,dtype->object]
##
##diagnostics: theta_i_long (besides the group key exp) has dtype object, so GroupBy.mean() can’t average it.
# keep exp as the group key, average numeric cols only
MEDS = (
    theta_i_long
...
save_parent_strength2(setup_hier_ptw, setup_hier_ptw.models[0], df_dirich.reset_index(drop=True), path_to_results+'parent_strength.csv') # saves parent distribution
