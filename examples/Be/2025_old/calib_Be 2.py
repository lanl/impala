...
plt.close('all')
pp.parameter_trace_plot(np.asarray(df0),ylim=[0,1])
plt.savefig(path_to_plots + 'trace0.png')

plt.close('all')
pp.parameter_trace_plot(np.asarray(theta_exp[0]),ylim=[0,1])
plt.savefig(path_to_plots + 'trace_exp0.png')
