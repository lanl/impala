...
path_to_data1 = '/Users/jyplohr/impala_runs/Be/data/QS_SHPB_Z_2017/'
...
dat0 = np.loadtxt(path_to_data1 + "Bef200c1e-3_Mbar.txt")
dat1 = np.loadtxt(path_to_data1 + "Bef300c1_Mbar.txt")
dat2 = np.loadtxt(path_to_data1 + "Bef400c1_Mbar.txt")
dat3 = np.loadtxt(path_to_data1 + "Bef500c1_Mbar.txt")
dat4 = np.loadtxt(path_to_data1 + "Bef600c1_Mbar.txt")
dat5 = np.loadtxt(path_to_data1 + "Bed50433_Mbar.txt")
dat6 = np.loadtxt(path_to_data1 + "Bed30393_Mbar.txt")
dat7 = np.loadtxt(path_to_data1 + "Bed20373_Mbar.txt")
dat8 = np.loadtxt(path_to_data1 + "Bef0203500_Mbar.x.txt")
dat9 = np.loadtxt(path_to_data1 + "Bed-50353_Mbar.txt")
...
class BGP_PW_Shear_Modulus_Fixed(impala.physics.BaseModel):
    ...
    def value(self, *args):
        ...
        gnow[np.where(temp >= tmelt)] = (cold_shear*(1.- mp.alpha))[np.where(temp >= tmelt)]
