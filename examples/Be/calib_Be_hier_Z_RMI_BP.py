#########################################
#########################################
### Beryllium Hierarchical PTW-BP Calibration ###
#########################################
#########################################
...
path_to_results = '/Users/jyplohr/impala_runs/Be/hierarchical_Z_RMI_PTW-BP/results/'
path_to_plots = '/Users/jyplohr/impala_runs/Be/hierarchical_Z_RMI-BP/plots/'
...
for j in range(len(theta_exp)):
    ...
    elif(edots[j] > 1 * j < (len(theta_exp)-1)):
...
palette = ['tab:blue','tab:purple','tab:orange','tab:red']
