...
for i in range(nfiles_104):
    with open(files2_104[i]) as file:
        temp = file.readlines()
        dat_104[i] = np.vstack([
            np.float_(str.split(temp[i])) for i in range(2, len(temp))
        ])

path_105 = os.path.abspath(
    "../../../Downloads/realTime-master-AlAl-data_trial5/AlAl/data_trial5/105S/"
)
...
path_106 = os.path.abspath(
    "../../../Downloads/realTime-master-AlAl-data_trial5/AlAl/data_trial5/106S/"
)
...
ifunc = interp1d(obs2[:, 1] - 0.2, obs2[:, 0] * 1e-4, kind="cubic")
...
np.savetxt(
    "./../data/Al-5083/flyer_data/sims104.csv", sims_all[0], delimiter=","
)
np.savetxt(
    "./../data/Al-5083/flyer_data/sims105.csv", sims_all[1], delimiter=","
)
np.savetxt(
    "./../data/Al-5083/flyer_data/sims106.csv", sims_all[2], delimiter=","
)
...
np.savetxt(
    "./../data/Al-5083/flyer_data/xsims104.csv", xx_all[0], delimiter=","
)
np.savetxt(
    "./../data/Al-5083/flyer_data/xsims105.csv", xx_all[1], delimiter=","
)
np.savetxt(
    "./../data/Al-5083/flyer_data/xsims106.csv", xx_all[2], delimiter=","
)
