...
setwd('~/Desktop/immpala_data//Cu-Cu_Thomas_PlateImpact/')
...
load('~/Desktop/immpala_data/Copper_Taylor_Results_2019-05-29/features.rda')
...
save.image('~/Desktop/immpala_data/calib_start.rda')
