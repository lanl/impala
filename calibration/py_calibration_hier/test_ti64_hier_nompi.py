...
if __name__ == '__main__':
    if rank > 0:
        ...
        model.sample(400, 1)
        model.write_to_disk('./results/Ti64/res_ti64_hier.db', 200, 1)
        model.plot_accept_probability('./results/Ti64/res_ti64_hier_accept.png', 200)
        model.plot_swap_probability('./results/Ti64/res_ti64_hier_swapped.png', 200 // 5)
        model.complete()
