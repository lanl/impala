...
if __name__ == '__main__':
    if rank > 0:
        ...
        model.write_to_disk('./results/Ti64/res_ti64_hier.db', 20000, 5)
        model.plot_accept_probability('./results/Ti64/res_ti64_hier_accept.png', 20000)
        model.plot_swap_probability('./results/Ti64/res_ti64_hier_swapped.png', 20000 // 5)
        model.complete()
