...
def genCandBasis(maxInt, I_vec, z_vec, p, xdata):
    ...
    out = namedtuple('out', 'basis n_int signs vs knots lbmcmp')
    return out(basis, n_int, signs, vs, knots, lbmcmp)
...
def genBasisChange(knots, signs, vs, tochange_int, xdata):
    ...
    out = namedtuple('out', 'basis signs vs knots')
    return out(basis, signs_cand, vs, knots_cand)
