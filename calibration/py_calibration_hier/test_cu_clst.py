...
if __name__ == '__main__':
    if rank > 0:
        ...
        model.sample(400, 1)
        model.write_to_disk('./results/copper/res_cu_clst.db', 200, 1)
        model.plot_accept_probability('./results/copper/res_cu_clst_accept.png', 200)
        model.plot_swap_probability('./results/copper/res_cu_clst_swapped.png', 200// 1)
        model.complete()
